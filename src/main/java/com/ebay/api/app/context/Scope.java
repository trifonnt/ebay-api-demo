...
public interface Scope {
	...
	List<String> ALL_SCOPES = Arrays.asList(PUBLIC, SELL_MARKETING_READONLY, SELL_MARKETING, SELL_INVENTORY_READONLY,
			SELL_INVENTORY, SELL_ACCOUNT_READONLY, SELL_ACCOUNT, SELL_FULFILLMENT_READONLY, SELL_FULFILLMENT,
			SELL_ANALYTICS_READONLY, SELL_FINANCES, SELL_PAYMENT_DISPUTE, SELL_IDENTITY_READONLY);

	//@Trifon
	List<String> TRIFON = Arrays.asList(SELL_FULFILLMENT_READONLY);
}
